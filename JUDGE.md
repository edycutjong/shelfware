...
| Tests | **90** (85 offline in ~1 s, 5 live against the real contract), 9 named for the defect they pin, one property over 500 generated ledgers |
| Latency | ticker question p50 **566 ms** keyless (p95 1,040 ms); the join itself 1.1 ms |

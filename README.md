...
![Tests](https://img.shields.io/badge/tests-90-3BD37D?style=flat)
...
**90 tests** — 85 offline (`make test`, ~1 s, no internet), 5 live against the real contract
(`make test-live`, keyless). Nine regressions are named for the defect they pin, each seen against
